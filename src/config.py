...
IG_LOGIN_MODE = os.getenv("IG_LOGIN_MODE", "facebook").lower()
IG_API_VERSION = os.getenv("IG_API_VERSION", "v26.0")
...
# ---------------- 브랜딩 ----------------
HANDLE = os.getenv("CARD_HANDLE", "@daily.data.kr")
DRY_RUN = os.getenv("DRY_RUN", "0") == "1"

# ---------------- 지역 설정 ----------------
# 기상청 격자 (서울 중구 기준)
WEATHER_NX = int(os.getenv("WEATHER_NX", "60"))
WEATHER_NY = int(os.getenv("WEATHER_NY", "127"))
WEATHER_REGION = os.getenv("WEATHER_REGION", "서울")

# 에어코리아 시도명
AIR_SIDO = os.getenv("AIR_SIDO", "서울")
...
# 오피넷 지역코드 (01=서울)
OPINET_AREA = os.getenv("OPINET_AREA", "01")
